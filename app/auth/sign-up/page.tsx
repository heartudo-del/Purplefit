      ...
      <div className="w-full max-w-sm">
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-4">
            ...
            <h1 className="text-2xl font-bold text-center">Join Purple Fit</h1>
            <p className="text-muted-foreground text-center text-sm">Create your nutritionist account</p>
          </div>
          <Card>
            <CardHeader>
